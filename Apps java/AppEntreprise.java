...
public class AppEntreprise {
    ...
    public static void main(String[] args) {
        AppEntreprise app = new AppEntreprise();
        app.demarrer();
    }
...
//        String url = "jdbc:postgresql://172.24.2.6/dbkevishgawri";
    ...
    private boolean en_Connection(String id, String mdp){
    ...
    private void en_EncoderOffreStage() {
    ...
    private void en_SelectionnerEtudiant() {
